...
//            return;
//        }
//        Collection<Entities> entities = MapperUtils.findMappers(psiMethod.getProject());
//
...
//
//        entities.stream()
//                .flatMap(entitiy -> entitiy.getDaoElements().stream())
...
//    }
    ...
    public void processClass(@NotNull PsiClass clazz, @NotNull Processor<Entities> processor) {
        String ns = clazz.getQualifiedName();
//        for (Entities entitiy : MapperUtils.findMappers(clazz.getProject())) {
//            if (MapperUtils.getNamespace(entitiy).equals(ns)) {
//                processor.process(entitiy);
//            }
//        }
    }
     ...
     * @return the optional
     */
//    public Optional<Entities> findWithFindFirstProcessor(@NotNull PsiClass target) {
//        CommonProcessors.FindFirstProcessor<Entities> processor = new CommonProcessors.FindFirstProcessor<>();
